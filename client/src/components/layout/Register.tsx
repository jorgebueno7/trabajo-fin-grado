...
//                     </div> */}
                    ...
                    //             onChange={e => setRole(e.target.checked ? "Administrador" : "Estandar")} />
...
//     const fetchUsers = async () => {
//         const users = await getUsers();
//         const adminExists = users.some((user: User) => user.isAdminUser);  // Verificamos si ya existe un admin
//         setIsAdminExists(adminExists);

//         // Si no existe un admin, permitir que el próximo usuario pueda ser administrador
//         if (!adminExists) {
//             setIsAdminUser(false);  // Por defecto no es admin, pero puede cambiar
//         }
//     };
...
//         event.preventDefault();
//         try {
//             console.log({ dni, nombre, apellidos, email, password, isAdminUser });
...
//                         </label>
//                     </div>
//                     <button type="submit" className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrar cuenta</button>
//                 </form>
//             </div>
//         </div>
//     );
